import{w as p,u as n,e as u}from"./index-Ch1O_M5-.js";import{L as d}from"./LoginForm-C1RJFaV1.js";import"./jsx-runtime-D_zvdyIk.js";import"./index-D4lIrffr.js";import"./auth.selectors-BAS4YwMG.js";import"./react-redux-Dn6r42s_.js";import"./auth.slice-j1dU8zPF.js";import"./i18n.hook-BDEYJONy.js";import"./i18n.context-Blb_uceL.js";const R={title:"ports/auth/LoginForm",component:d},e={},a={play:async({canvasElement:l})=>{const t=p(l);await n.type(t.getByLabelText("Email"),"member@example.com"),await n.click(t.getByRole("button",{name:"Send login link"})),await u(await t.findByRole("alert")).toBeInTheDocument()}};var o,r,s;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:"{}",...(s=(r=e.parameters)==null?void 0:r.docs)==null?void 0:s.source}}};var i,m,c;a.parameters={...a.parameters,docs:{...(i=a.parameters)==null?void 0:i.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
