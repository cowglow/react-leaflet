...
import createEditableListControl from "ports/components/editable-list/create-editable-list-control.ts";
...
function EditableList(props: EditableListProps) {
  ...
  useEffect(() => {
    ...
    const control = createEditableListControl({ position: "bottomleft" });
